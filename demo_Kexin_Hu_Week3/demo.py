...
ground_truths = {
    ...
    "formula4.png": '<math display="block">(\\mathbf{A} - \\sigma \\mathbf{I})^{-1} \\mathbf{x} = \\frac{1}{\\lambda - \\sigma} \\mathbf{x}</math>',
    "formula5.png": '<math display="block">\\mathbf{x}_0 = \\alpha_1 \\mathbf{u}_1 + \\alpha_2 \\mathbf{u}_2 + \\cdots + \\alpha_n \\mathbf{u}_n</math>',
